...
add_task(async function test_determineNonSyncableGuids() {
  ...
  let arrayOfVisits = [
    { uri: "https://splendor.network/", transition: TRANSITION_TYPED },
...
add_task(async function test_fetchURLInfoForGuid() {
  ...
  let visits = [
    { uri: "hhttps://splendor.network/", title: "mozilla" },
